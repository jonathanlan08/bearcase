...
import { api, type Claim, type ClaimDetail, type Deal, type DealListItem, type DealSummary, type Doc, type Financials, type Finding, type Job, type Report, type Scenario, type ScenarioFacts, type AuditEvent, type Evidence } from "@/lib/api";
